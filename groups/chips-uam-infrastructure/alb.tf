# ------------------------------------------------------------------------------
# CHIPS UAM ALB Security Group and rules
# ------------------------------------------------------------------------------
module "chips_uam_external_alb_security_group" {
...
module "chips_uam_external_alb" {
  ...
  security_groups = [module.chips_uam_external_alb_security_group.this_security_group_id]
...
module "alb_proxy_metrics" {
  ...
  load_balancer_id = module.chips_uam_external_alb.this_lb_id
  target_group_ids = module.chips_uam_external_alb.target_group_arns

  depends_on = [module.chips_uam_external_alb]
}